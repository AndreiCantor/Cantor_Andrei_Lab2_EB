...
namespace Cantor_Andrei_Lab2.Migrations
{
    ...
    [Migration("20241126151457_AddBookViewModel")]
    partial class AddBookViewModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cantor_Andrei_Lab2.Models.Genre", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cantor_Andrei_Lab2.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("Cantor_Andrei_Lab2.Models.Book", b =>
                {
                    ...
                    b.HasOne("Cantor_Andrei_Lab2.Models.Genre", "Genre")
                        .WithMany()
            ...
            modelBuilder.Entity("Cantor_Andrei_Lab2.Models.Order", b =>
                {
                    ...
                    b.HasOne("Cantor_Andrei_Lab2.Models.Customer", "Customer")
                        .WithMany("Orders")
